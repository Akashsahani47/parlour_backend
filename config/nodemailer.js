...
//   from: "Asha Beauty Parlour <info@ashabeauty.com>",
...
//   port: 587,
//   secure: false, // Brevo recommends false for TLS
//   auth: {
...
//     const mailOptions = {
//       from: `"Asha Beauty Parlour" <${process.env.BREVO_USER}>`,
//       to: booking.user.email,
//       subject: `✅ Appointment Confirmed - ${booking.service.name} | Asha Beauty Parlour`,
//       html: `
//     <!DOCTYPE html>
...
//     console.log("✅ Email sent successfully and booking confirmed");
//     return { success: true, message: "Email sent and booking confirmed" };
